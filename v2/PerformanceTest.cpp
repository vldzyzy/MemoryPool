...
public:
    ...
    static void testSmallAllocation() {
        ...
        std::cout << "\nTesting small allocation (" << NUM_ALLOCS << " allocations of "
    ...
    static void testMixedSizes() 
    {
        ...
        const size_t SIZES[] = {16, 32, 64, 128, 256, 512, 1024, 2048};   // 128, 256, 512, 1024, 2048
